...
//            <input id="getRowDataRowIndex" value="0"/>
//
//            <input id="getChangedRowsData" type="button" value="getChangedRowsData"/>

$('#addRow').click(function() {
    $('#tableComponent').jsTableComponent('addRow');
});
$('#getRow').click(function() {
    var index = $('#getRowIndex').val();
    alert($('#tableComponent').jsTableComponent('getRow', index));
});
$('#deleteRow').click(function() {
    var index = $('#deleteRowIndex').val();
    alert($('#tableComponent').jsTableComponent('deleteRow', index));
});
$('#getRowData').click(function() {
    var index = $('#getRowDataIndex').val();
    alert('Stringified: ' + JSON.stringify( $('#tableComponent').jsTableComponent('getRowData', index ) ));
});
$('#getChangedRowsData').click(function() {
    alert('Stringified: ' + JSON.stringify( $('#tableComponent').jsTableComponent('getChangedRowsData') ));
});